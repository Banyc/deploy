...
//! status decision — [`crate::deploy::status::disposition_for`] — plus the
...
use crate::deploy::execute::ExecutionOutcome;
use crate::deploy::push::{PushContext, PushReport};
use crate::error::Result;
use crate::identity::SlotId;
use crate::ledger::{
    self, DeploymentIntent, DeploymentStatus, LedgerIntentReport, LedgerTerminal, SlotOutcome,
...
pub(crate) fn run_commit(
    ...
    if execution.commit_status == DeploymentStatus::Successful {
        ...
        let disposition = super::status::disposition_for(&execution.commit_status, outcomes)?;
...
pub(crate) mod tests {
    ...
    //! [`crate::deploy::push::push`] with the shared harnesses from
