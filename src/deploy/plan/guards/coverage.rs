//! The behavior-coverage gate: [`validate_behavior_coverage`] requires
//! every selected slot's behavior contract to be present in the frozen
//! behavior index BEFORE any remote state is changed.
