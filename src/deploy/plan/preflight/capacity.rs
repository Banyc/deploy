//! Preflight headroom: [`capacity_preflight`] reserves capacity for a push
//! (with best-effort retention freeing), [`capacity_fits`] is the
//! overflow-free reserve comparison.
