//! Post-mutation status / disposition: [`decide_commit_status`] runs the
//! per-slot commit-marker step and decides the final status;
//! [`disposition_for`] maps the status to the terminal disposition.
