...
//! carries.
//!
//! The two physical line kinds ([`crate::ledger::append::LedgerLine`] —
//! the WIRE enum the append-only JSONL stream carries) live in
//! [`crate::ledger::append`]; the merged ENTRY is this module's
...
use crate::ledger::terminal::LedgerTerminal;
...
mod tests {
    use super::*;
    // The ledger's two line kinds live in [`crate::ledger::append`]; the
    ...
    use crate::ledger::append::LedgerLine;
