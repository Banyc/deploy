...
//! report ([`LedgerIntentReport`]). The physical [`crate::ledger::append::LedgerLine::Intent`]
//! line lives in [`crate::ledger::append`].
...
use crate::ledger::records::{NonEmptySlotTable, SlotAttemptState};
