...
/// Canonical digest over name-sorted per-variant capacity policies. The digest
...
pub fn release_digest(
    ...
    let payload = CanonicalReleasePayload {
        ...
        policies_sha256: policies_sha.to_string(),
...
pub fn build_release(
    ...
    let bindings: BTreeMap<String, String> = variants
        ...
        .collect();
    let digest = release_digest(mapping_sha, behavior_sha, policies_sha, &bindings);
